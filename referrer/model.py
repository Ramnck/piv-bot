...
class Referrer:
    ...
    def make_referrence(self, user_prompt: str, bottle_infos: list[Info]) -> str:
        ...
        prompt = (
            ...
            "Среди доступных сортов пива выбери один, который соответствует моим предпочтениям. Объясни выбор в 1–2 предложениях без лишних подробностей.\n"
            f"Вот мои предпочтения:\n{user_prompt}\n\n"
